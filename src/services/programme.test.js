...
const index = {
  ...
  popular: { i: 2, t: 'Night of the Living Dead', y: 1968, p: '/b.jpg', v: 7.6, k: 200, c: 1 },
  shaky: { i: 3, t: 'Something', y: 1980, p: '/c.jpg', v: 9.9, k: 200, c: 0.72 },
  no_poster: { n: 1, c: 0.9 },
...
test('shelfFor picks a decade with enough films and rotates it by day', () => {
  ...
  for (const e of Object.values(big)) e.k = 3;
  assert.equal(shelfFor(big), null, 'a rating from three people is not well regarded');
...
test('shortRow offers well-regarded films you can finish in an evening', () => {
  const idx = {
    short: { i: 1, t: 'Detour', y: 1945, p: '/a.jpg', v: 7.2, k: 200, c: 1, l: 68 },
    long: { i: 2, t: 'Epic', y: 1959, p: '/b.jpg', v: 8, k: 200, c: 1, l: 212 },
    clip: { i: 3, t: 'Clip', y: 1960, p: '/c.jpg', v: 9, k: 200, c: 1, l: 12 },
    meh: { i: 4, t: 'Meh', y: 1960, p: '/d.jpg', v: 5, k: 200, c: 1, l: 80 },
    unknown: { i: 5, t: 'No length', y: 1960, p: '/e.jpg', v: 8, k: 200, c: 1 },
...
test('sameShelf finds films that share a genre, same decade first, one card per film', () => {
  const idx = {
    me: { i: 1, t: 'House on Haunted Hill', y: 1959, p: '/a.jpg', v: 6.7, k: 200, c: 1, g: ['Horror', 'Thriller'] },
    same: { i: 2, t: 'The Bat', y: 1959, p: '/b.jpg', v: 6.1, k: 200, c: 1, g: ['Horror', 'Mystery'] },
    same_dupe: { i: 2, t: 'The Bat', y: 1959, p: '/b.jpg', v: 6.1, k: 200, c: 1, g: ['Horror', 'Mystery'] },
    later: { i: 3, t: 'Scanners', y: 1981, p: '/c.jpg', v: 6.7, k: 200, c: 1, g: ['Horror', 'Sci-Fi'] },
    other: { i: 4, t: 'His Girl Friday', y: 1940, p: '/d.jpg', v: 7.8, k: 200, c: 1, g: ['Comedy'] },
    weak: { i: 5, t: 'Weak', y: 1959, p: '/e.jpg', v: 3, k: 200, c: 1, g: ['Horror'] },
    nogenre: { i: 6, t: 'Untagged', y: 1959, p: '/f.jpg', v: 7, k: 200, c: 1 },
  };
