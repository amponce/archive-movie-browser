...
- [@fatihcvs](https://github.com/fatihcvs) - shared film links clear their hash when the film is closed ([#48](https://github.com/amponce/archive-movie-browser/pull/48))
