...
| One hand-picked cult film a day, what is on the channels, and rows with a reason. | Twenty-five channels playing their lineups in order from a fixed moment, so the same film is on for everyone. Tune in mid-film. |
...
2. **A channel of your own.** A lineup kept in the URL and your browser, on the same clock, so a link to it shows the same minute to anyone.
