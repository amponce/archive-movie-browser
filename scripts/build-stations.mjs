...
const STATIONS = [
  ...
  { slug: 'rental-comedy', title: 'Rental comedy', blurb: 'The 80s comedies that wore out the tape at the video store. Well loved, not the blockbusters.', genre: 'Comedy', decades: [1980, 1980], count: 32, quality: { min: 6.0, maxVotes: 5000 } },
  { slug: 'cassette-futures', title: 'Cassette futures', blurb: '1980s science fiction on a VHS budget: mutants, machines and futures that went wrong.', genre: 'Sci-Fi', decades: [1980, 1980], count: 32, quality: { min: 6.0, maxVotes: 5000 } },
  ...
  { slug: 'spies-and-capers', title: 'Spies and capers', blurb: 'Sixties thrillers and heists: kidnappings, double agents and one perfect plan.', genres: ['Thriller', 'Crime'], not: ['Horror'], decades: [1960, 1960], count: 32, quality: { min: 6.3, maxVotes: 5000 } },
